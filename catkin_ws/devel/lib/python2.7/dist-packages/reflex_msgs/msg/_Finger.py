...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.contact is None:
        self.contact = [False,False,False,False,False,False,False,False,False]
      if self.pressure is None:
        self.pressure = [0.,0.,0.,0.,0.,0.,0.,0.,0.]
    else:
      self.proximal = 0.
      self.distal_approx = 0.
      self.contact = [False,False,False,False,False,False,False,False,False]
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_9B.pack(*self.contact))
      buff.write(_struct_9f.pack(*self.pressure))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.contact = _struct_9B.unpack(str[start:end])
      self.contact = map(bool, self.contact)
      start = end
      end += 36
      self.pressure = _struct_9f.unpack(str[start:end])
      return self
