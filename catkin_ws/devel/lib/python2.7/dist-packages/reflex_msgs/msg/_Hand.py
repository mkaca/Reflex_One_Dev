  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.finger is None:
        self.finger = [reflex_msgs.msg.Finger(),reflex_msgs.msg.Finger(),reflex_msgs.msg.Finger()]
      if self.motor is None:
        self.motor = [reflex_msgs.msg.Motor(),reflex_msgs.msg.Motor(),reflex_msgs.msg.Motor(),reflex_msgs.msg.Motor()]
    else:
      self.finger = [reflex_msgs.msg.Finger(),reflex_msgs.msg.Finger(),reflex_msgs.msg.Finger()]
      self.motor = [reflex_msgs.msg.Motor(),reflex_msgs.msg.Motor(),reflex_msgs.msg.Motor(),reflex_msgs.msg.Motor()]
  ...
  def serialize(self, buff):
    ...
    try:
      for val1 in self.finger:
        ...
        buff.write(_struct_9B.pack(*val1.contact))
        buff.write(_struct_9f.pack(*val1.pressure))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, 3):
        ...
        val1.contact = _struct_9B.unpack(str[start:end])
        val1.contact = map(bool, val1.contact)
        start = end
        end += 36
        val1.pressure = _struct_9f.unpack(str[start:end])
