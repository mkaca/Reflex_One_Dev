  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.finger is None:
        self.finger = [reflex_msgs.msg.FingerPressure(),reflex_msgs.msg.FingerPressure(),reflex_msgs.msg.FingerPressure()]
    else:
      self.finger = [reflex_msgs.msg.FingerPressure(),reflex_msgs.msg.FingerPressure(),reflex_msgs.msg.FingerPressure()]
  ...
  def serialize(self, buff):
    ...
    try:
      for val1 in self.finger:
        buff.write(_struct_9H.pack(*val1.sensor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, 3):
        ...
        val1.sensor = _struct_9H.unpack(str[start:end])
