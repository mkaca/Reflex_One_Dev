...
(cl:defmethod cl:initialize-instance :after ((m <Contact>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Contact)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name takktile_ros-msg:<Contact> is deprecated: use takktile_ros-msg:Contact instead.")))
